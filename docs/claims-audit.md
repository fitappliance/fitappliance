...
| `README.md` project status | `Raw specs catalog: 2,188 products; Retailer-verified products: 66; Verified retailer links: 139; Live price rows: 0` | Public data contains raw specs, but retailer-link coverage is a separate evidence layer. | Keep separated; do not describe raw catalog rows as retailer inventory. |
