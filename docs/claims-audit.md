...
| `README.md` project status | `Raw specs catalog: 2,214 products; retailer-verified products: 66; verified retailer links: 177; live price rows: 0` | Public data contains raw specs, but retailer-link coverage is a separate evidence layer. | Keep separated; do not describe raw catalog rows as retailer inventory. |
