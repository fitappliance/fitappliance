...
## Site Stats (Current)
- **3,521 raw appliance spec rows** across fridges, washing machines, dishwashers, and dryers
- **1,386 products with verified retailer product-page links** across the five tracked AU retailers
- **1,616 verified retailer product-page links**; live price rows are 688
...
>
> Built fitappliance.com.au — it checks 3,521 raw appliance spec rows, checks your exact cavity dimensions,
...
>
> **FitAppliance** covers 3,521 fridge/washer/dishwasher/dryer spec rows with:
...
> Covers 3,521 raw spec rows, 290 brand-specific clearance guides, and verified retailer product-page links where available.
...
2. **3,521 raw spec rows** — a broad Australian appliance sizing database, with retailer-link coverage tracked separately.
...
8. "bosch dishwasher clearance australia" — 93 Bosch dishwasher models in database
9. "fisher & paykel dishwasher clearance australia" — 61 Fisher & Paykel dishwasher models in database
10. "smeg dishwasher clearance australia" — 60 Smeg dishwasher models in database
