...
## Site Stats (Current)
- **2,268 raw appliance spec rows** across fridges, washing machines, dishwashers, and dryers
...
>
> Built fitappliance.com.au — it checks 2,268 raw appliance spec rows, checks your exact cavity dimensions,
...
>
> **FitAppliance** covers 2,268 fridge/washer/dishwasher/dryer spec rows with:
...
> Covers 2,268 raw spec rows, 292 brand-specific clearance guides, and verified retailer product-page links where available.
...
2. **2,268 raw spec rows** — a broad Australian appliance sizing database, with retailer-link coverage tracked separately.
