...
- `scripts/generate-geo-treatment-report.js`
- `tests/geo-treatment-report.test.mjs`
...
- Create: `scripts/generate-geo-treatment-report.js`
- Create: `tests/geo-treatment-report.test.mjs`
- Modify: `package.json`
...
- [ ] Write `scripts/generate-geo-treatment-report.js` to validate that every listed URL maps to an existing HTML file.
- [ ] Write test ensuring missing URLs fail validation.
- [ ] Add npm script:

```json
"geo-treatment-report": "node scripts/generate-geo-treatment-report.js"
```

- [ ] Run:

```bash
npm test -- tests/geo-treatment-report.test.mjs
npm run geo-treatment-report
```
...
**Files:**
- Create: `scripts/common/geo-blocks.js`
- Create: `tests/geo-blocks.test.mjs`
...
- [ ] Implement `scripts/common/geo-blocks.js`.
- [ ] Run:

```bash
npm test -- tests/geo-blocks.test.mjs
```
...
```bash
git add scripts/common/geo-blocks.js tests/geo-blocks.test.mjs
...
- Test: add coverage to existing guide-generation tests if present; otherwise add `tests/guide-geo-blocks.test.mjs`.
