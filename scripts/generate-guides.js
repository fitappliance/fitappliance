...
const GUIDE_ARTICLES = {
  ...
  'appliance-fit-sizing-handbook': {
    ...
    intro: [
      ...
      'FitAppliance covers 2,188 raw spec rows across four categories: fridges, dishwashers, washing machines, and dryers. Verified retailer product-page links are tracked separately, so the tool is useful only when the measurements and link evidence are read with the right context. Use this guide to collect those measurements properly.'
    ],
    figures: [
