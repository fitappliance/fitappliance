  ...
  return {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: `Inadequate ventilation clearance can make the ${unit} work harder and may shorten component life. Check the model manual and installer guidance before fitting.`
        }
      }
    ]
  };
